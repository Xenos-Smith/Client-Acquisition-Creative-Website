...
<div class="w-full h-fit flex justify-center gap-4 items-center mb-20 flex-col pt-10 bg-accent pb-20">
    <P class="text-text-white text-xl max-w-screen-md text-center w-full">We only have...</P>
    <Heading tag="h1" class="text-text-white text-[200px] font-black max-w-screen-xl text-center w-full">
        1 Spot
    </Heading>
